...
> 给未来任何会话的"我"：读完本文件即可无缝接管此项目。
> ⚠️ **完整交接（含全部 API 凭据、双站架构、命令、坑位、验收清单）见 `E:\BLOG\HANDOVER.md`（`E:\blogb\HANDOVER.md` 同内容，含密钥，已 gitignore，绝不入库）**。
> 最后更新：2026-08-31（博客站已完整上线并多轮迭代，详见 HANDOVER.md）
