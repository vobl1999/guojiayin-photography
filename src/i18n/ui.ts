...
const zh: Record<keyof typeof en, string> = {
  ...
  'licence.title': '使用须知',
  'licence.text': '照片仅供个人欣赏与学习使用，禁止任何形式的商用、转载与二次分发。',
  'licence.never': '下次不再提醒',
  'licence.ok': '好',
  'licence.cancel': '取消',
  'gallery.prev': '上一张',
  'gallery.next': '下一张',
